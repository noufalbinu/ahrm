        ...
        <div class="cv-section-container">
          <div class="cv-section-one">
            ...
            <div class="field-container">
              ...
              <input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="field-input" placeholder="Mobile"  maxlength="10" id="phone" name="phone">
			...
			<div class="field-container">
              ...
              <input value="<?php echo $current_user->user_email; ?>" type="text" class="field-input" placeholder="Write your subject of message" id="subject" name="subject" >
              <small class="field-msg error" data-error="invalidEmail">Your Email is Required</small>
            </div>
        ...
        document.addEventListener("DOMContentLoaded", function(e) {
            ...
            a.addEventListener("submit", function(e) {
                ...
                var r = {  
                    ...
                    subject: a.querySelector('[name="subject"]').value,
